  ...
  return (
    <div className="w-full flex justify-center items-center min-h-[77vh] bg-black">
      <div className=" animate__animated   animate__pulse">
        ...
        <input
          className="sm:w-[400px] sm:h-[50px]  h-[30px] mt-2 px-2  border-white
        ...
        />{" "}
        <br />
        <button onClick={handleOnClick}    className='mt-6 text-[18px] inline-block outline-none border-none cursor-pointer will-change-[box-shadow,transform] bg-slate-700 px-5 sm:px-8 py-0 rounded-md text-white h-8 sm:h-[2.6em] shadow-[0_1px_0_rgba(0,0,0,0.4)] transition-shadow  duration-150 ease-in-out' >
          {" "}
          Sign Up
        </button>
      </div>
